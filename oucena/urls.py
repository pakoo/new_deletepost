...
#     url(r'^search/(?P<qs>\w+)/$', 'hotkw.kw.views.getPic'),
     ...
     url(r'^tu/hide', 'shantie.views.hide_tu'),
     ...
     url(r'^liyi/post/(?P<post_url>\w+)', 'shantie.views.get_tieba_post'),
     url(r'^liyi/(?P<page>\d+)', 'shantie.views.diba'),
     url(r'^liyi/hot/(?P<page>\d+)', 'shantie.views.tieba_today_hot'),
