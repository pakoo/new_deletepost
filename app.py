...
class weixin(tornado.web.RequestHandler):
    ...
    def post(self):
        if self.msgtype == 'text':
            ...
            self.send_text("""天津瀚福精密液压技术有限公司坐落于渤海明珠天津海河科技园，聚集了多位热爱液压行业，专注于液压技术创新，以发展提升民族液压水平为使命的行业资深人士共同创立，自创品牌 HANFOOK 瀚福液压。 瀚，寓意液压广泛的应用领域和瀚福人追求更宽广、博大的幸福的胸怀；  福，寓意来自中国的民族液压品牌，和体现瀚福人为公司及社会创造价值和福祉的企业文化。瀚福液压旨在为客户产品增值、节能，与供应链共同降本、增效，通过技术创新、无限服务、应需而变、紧密合作实现多赢共赢。致力于液压系统的高度集成与方案优化，为液压领域提供全方位的解决方案是我们的企业目标与追求；共福共赢，成就你我，成为液压技术世界领先品牌是瀚福液压的企业梦想和愿景。""")
